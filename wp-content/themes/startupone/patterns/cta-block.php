...
/**
 * Title: CTA Block
 * Slug: startupone/cta-block
 * Categories: startupone-patterns
 */
$startupone_url = trailingslashit(get_stylesheet_directory_uri());
$startupone_images = array(
    $startupone_url . 'assets/images/cta_bg.jpg'
);
?>
<!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:cover {"url":"<?php echo esc_url($startupone_images[0]) ?>","id":6302,"dimRatio":90,"overlayColor":"primary","minHeight":540,"layout":{"type":"constrained"}} -->
    <div class="wp-block-cover" style="min-height:540px"><span aria-hidden="true" class="wp-block-cover__background has-primary-background-color has-background-dim-90 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-6302" alt="" src="<?php echo esc_url($startupone_images[0]) ?>" data-object-fit="cover" />
        <div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"860px"}} -->
            <div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"60px","lineHeight":"1.2"}},"className":"fotawp-flip-up"} -->
                <h1 class="wp-block-heading has-text-align-center fotawp-flip-up" style="font-size:60px;font-style:normal;font-weight:500;line-height:1.2"><?php esc_html_e('Looking for best agency to work together?', 'startupone') ?></h1>
                <!-- /wp:heading -->

                <!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.5"}},"className":"fotawp-fade-up","fontSize":"medium"} -->
                <p class="has-text-align-center fotawp-fade-up has-medium-font-size" style="line-height:1.5"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'startupone') ?></p>
                <!-- /wp:paragraph -->
